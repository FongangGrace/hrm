...
if(!$conn){
 ...
 if($_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    echo "<h2 style='text-align:center; font-weight:bold; margin-top:30px;'>The Payroll Report</h2>";
    echo "<br>";
    echo "<br>";
        ...
        echo "<thead>";
            ...
            while($rows = mysqli_fetch_assoc($result)){
                ...
                echo "<tr>";
                    ...
                    echo "<td>" .$rows['Deduction'] ."</td>";
                    echo "<td>" .$rows['Bonus'] ."</td>";
                    echo "<td>" .$rows['Net_Salary'] ."</td>";
